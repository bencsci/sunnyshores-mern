...
const add = ({ token }) => {
  ...
  return (
    <div className="flex-1 min-h-screen flex items-center justify-center bg-teal-light py-4">
      <div className="bg-white p-6 md:p-8 lg:p-10 rounded-lg shadow-md w-full max-w-6xl">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="mt-4 bg-teal text-white px-4 py-2 rounded-lg hover:bg-teal-600 transition"
              >
                Add Review
              </button>
            </div>
